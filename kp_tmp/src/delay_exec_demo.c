/*
 * delay_exec.c -- Simple demonstration of the delay execute
 *
	      ...
	      int len, int *eof, void *data)
{
	...
	len = sprintf(buf, "before delay: %9li\n", j0);
	len = sprintf(buf, "after  delay: %9li\n", j1);
	*start = buf;
	return len;
}
...
MODULE_DESCRIPTION("Simple demonstration of delaying execute.");
