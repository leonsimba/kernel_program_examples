/*
 * notifier_demo.c --  Simple demonstration of user-defined notifier.
 *
...
static int my_event_handler1(struct notifier_block *self, unsigned long val, void *data)
{
	printk("I'm notifer 1, event = %ld\n", val);
	return NOTIFY_DONE;
}
static int
my_event_handler2(struct notifier_block *self, unsigned long val, void *data)
{
...
MODULE_DESCRIPTION("Simple demonstration of user-defined notifier");
